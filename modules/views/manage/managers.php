            ...
            <div class="row-fluid table">
                <table class="table table-hover">
                    ...
                    <tr class="first">
                        ...
                        <td>
                            <?php echo $value->adminemail; ?>
                        </td>
                        <td>
                            <?php echo date('Y-m-d H:i:s',$value->logintime); ?>
                        </td>
                        <td>
                            <?php echo long2ip($value->loginip); ?>
                        </td>
                        <td>
                        ...
                        <td class="align-right">
                            <?php if ($manager->adminid != 1): ?>
                                <a href="<?php echo yii\helpers\Url::to(['manage/del', 'adminid' => $value->adminid]) ?>">删除</a>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <?php endforeach;?>
                ...
                <?php
                    if (Yii::$app->session->hasFlash('deladmin')) {
                        echo Yii::$app->session->getFlash('deladmin');
                    }
                ?>
            </div>
